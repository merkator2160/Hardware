...
byte powerStatus = 255;       // индикатор вида питания: 255 - не показывать, остальное автоматически (0 - от сети, 1-5 уровень заряда батареи) (с)НР
...
#define normCO2 1000      // и выше - желтый
#define maxCO2 2000       // и выше - красный
