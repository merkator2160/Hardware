...
namespace Core.Sandbox.Units.SbusSoftwareDecoder.Helpers
{
	public static class FileHelper
	{
		...
		{
			SaveOnDisk(str, filePath, Encoding.UTF8, FileMode.CreateNew);
		}
		public static void SaveOnDisk(this String str, String filePath, Encoding encoding, FileMode mode)
		{
			using(var stream = new FileStream(filePath, mode, FileAccess.Write))
			{
				using(var streamWriter = new StreamWriter(stream, encoding))
				{
