...
namespace IotHub.Common.Const
{
	public static class ZigbeeDevice
	{
		...
		public const String SideRoomKaktusLightButton = "0x00158D000672710E";       // Xiaomi Aqara model: WXKG11LM, end device
		public const String SonoffThermometer = "0x00124B0022CF75B3";               // Model: SNZB-02, Battery model: SNZB-02, end device
		public const String SideRoomKaktusLightCircuitRelay = "0x60A423FFFED2EFAF"; // Model: BW-SHP13, router
		public const String LargeRoomCircuitRelay1 = "0x60A423FFFEFF8B47";          // Model: BW-SHP13, router
		...
		public const String KitchenKratonSensor = "0x00124B002203B9B9";             // Model: modkam.ru	DIYRuZ_Flower, end device
