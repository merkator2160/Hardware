...
namespace Common.Helpers
{
	...
	internal static class DelayHelper
	{
		...
		/// </param>
		public static void DelayMicroseconds(Int32 microseconds, Boolean allowThreadYield)
		{
			var start = Stopwatch.GetTimestamp();
			var minimumTicks = (UInt64)(microseconds * Stopwatch.Frequency / 1_000_000);
			...
			if(!allowThreadYield)
			{
				...
				while((UInt64)(Stopwatch.GetTimestamp() - start) < minimumTicks);
			}
			else
			{
		...
		/// this will prevent all other code from running.
		/// </param>
		public static void DelayMilliseconds(Int32 milliseconds, Boolean allowThreadYield)
		{
