...
namespace Common.Drivers
{
	...
	{
		private readonly Boolean _shouldDispose;
		...
		private Boolean _usePrecisionTimer = false;

		private Boolean _isRunning;
		private Boolean _isStopped = true;
		private Int32 _servoPin = -1;
		...
		public SoftwarePwmChannel(Int32 pinNumber, Int32 frequency = 400, Double dutyCycle = 0.5, Boolean usePrecisionTimer = false, GpioController controller = null, Boolean shouldDispose = true)
		{
			if(controller == null)
			{
